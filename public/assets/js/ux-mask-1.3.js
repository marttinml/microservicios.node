        ...
        switch(opts.type){
          case 'card':
                      ...
                      cntl.bind('keydown',function(e){
                        if(!(( e.which > 47 && e.which < 58 ) || (e.which > 95 && e.which < 106) || e.which == 8) && e.which != 37 && e.which != 38 && e.which != 39 && e.which != 40 && e.which != 16 && e.which != 36 && e.which != 13 && e.which != 8 && e.which != 224 && e.which != 17 && e.which != 86) {
                            e.preventDefault();
                        }
                        if(e.which === 8){
